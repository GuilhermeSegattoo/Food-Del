        ...
        <div className="login-popup">
          <form onSubmit={onLogin} className="login-popup-container">
            ...
            <div className="login-popup-inputs">
                {currState==="Login"?<></>:<input name="name" onChange={onChangeHandler} value={data.nome} type="text" placeholder="Seu Nome" required />}
            ...
            <button type="submit">{currState==="Entrar"?"Criar conta":"Login"}</button>
